...
## YOLOV4_coco_detection_car_picture Example
Function: uses the YOLOv4 model to perform prediction and inference on input images and print the results on output images.   
Input: JPG images.   
...
2. Obtain the source model required by the application.
    ...
    |---|---|---|
    |  YOLOv4| An object detection model based on ONNX-YOLOV4. | For details about how to download the source model, visit https://www.hiascend.com/en/software/modelzoo/detail/1/abb7e641964c459398173248aa5353bc. |
    ```
...
1. Run the following commands to upload the **YOLOV4_coco_detection_car_picture** directory in the development environment to any directory in the operating environment, for example, **/home/HwHiAiUser**, and log in to the operating environment (host) as the running user (**HwHiAiUser**):
    ```
...
After the execution is complete, the result images are saved in the **out** directory.
![输入图片说明](https://images.gitee.com/uploads/images/2021/1101/173046_d626bd95_5400693.png "屏幕截图.png")
